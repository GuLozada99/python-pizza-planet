...
@pytest.fixture
def order(
        create_ingredients, create_beverages,
        create_size, client_data) -> dict:
...
@pytest.fixture
def create_orders(client, order_uri, create_beverages,
                  create_ingredients, create_sizes) -> list:
    ingredients = [ingredient.get('_id') for ingredient in create_ingredients]
    beverages = [beverage.get('_id') for beverage in create_beverages]
